...
const useSliderStore = defineStore('sliderStore', () => {
  ...
  const retrieveSlidersFromDB = async () => {
    try {
      const response = await axios.get(
        'https://backendevony.evony.me/api/admin/get_sliders',
      );
  ...
  const deleteSlider = async id => {
    try {
      await axios.delete(
        `https://backendevony.evony.me/api/admin/deleteSlider/${id}`,
      );
  ...
  const createSlider = async (sliderData, headers = {}) => {
    try {
      await axios.post(
        'https://backendevony.evony.me/api/admin/createSlider',
        sliderData,
        { headers },
      );
  ...
  const updateSlider = async (id, sliderData, headers = {}) => {
    try {
      await axios.put(
        `https://backendevony.evony.me/api/admin/updateSlider/${id}`,
        sliderData,
        { headers },
      );
      await retrieveSlidersFromDB();
