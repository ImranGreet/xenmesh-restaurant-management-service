    ...
    <div
      ...
      <form
        ...
        <div class="w-full">
          ...
          <input
            type="text"
            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 transition duration-200 ease-in-out hover:bg-gray-50"
            name="icon"
