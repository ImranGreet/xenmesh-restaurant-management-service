      ...
      <div
        ...
        <div class="overflow-x-auto">
          <table
            ...
            <tbody>
              <tr
                v-for="order,index in orderInKitchen" :key="index"
                ...
                <th
                  ...
                  class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white border border-slate-300">
                    ...
                    <div class="flex gap-x-1">
                      ...
                      <div class="w-full flex flex-col justify-center items-center" v-for="itemImage,index in order.items_ordered" :key="index">
                        <img
                        :src="itemImage.image"
                ...
                <td class="px-4 py-2 border border-slate-300">{{order.customer_name}}</td>
                <td
                  class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white border border-slate-300">
                  {{ new Date(order.time_placed ).getDate() +'-'+ new Date(order.time_placed ).getMonth() +'-'+ new Date(order.time_placed ).getFullYear() }}
                </td>
                <td
                  class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white border border-slate-300">
                  Delete
...
export default {
  name: 'Kitchen Order',
  setup(){
    const orderInKitchen = order.filter((item)=>item.order_status==='kitchen');
