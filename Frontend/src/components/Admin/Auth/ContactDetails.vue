<template>
  <div class="bg-inherit px-3 py-2 w-full">
    ...
    class="w-full md:w-4/5 lg:3/4 xl:w-1/2 mx-auto border border-gray-600/25 rounded-lg bg-white p-5">
      <FormHeadLine>Contact Details</FormHeadLine>
      <form
        ...
        <div class="px-2  w-full space-y-3 border border-gray-200 py-3 rounded-md">
          <label for="icon" class="text-xl tracking-wide leading-7">Icon Name</label>
          <input
            type="text"
        ...
        <div class="px-2  w-full space-y-3 border border-gray-200 py-3 rounded-md">
          <label for="icon" class="text-xl tracking-wide leading-7">Category</label>
          <input
            type="text"
            class="w-full focus:outline-none text-start placeholder:text-gray-950 bg-inherit border border-gray-200 rounded-lg px-4 py-2"
            name="icon"
        ...
        <div class="px-2  w-full space-y-3 border border-gray-200 py-3 rounded-md">
          <label for="icon" class="text-xl tracking-wide leading-7">Icon Image</label>
          <input
            type="file"
            class="w-full focus:outline-none text-start placeholder:text-gray-950 bg-inherit border border-gray-200 rounded-lg px-4 py-2"
            name="icon" />
