<template>
      <div class="fixed top-16 w-full max-w-full px-4">
        <Popover v-slot="{ open }" class="relative">
          ...
          >
            <PopoverPanel
              class="absolute left-0 right-0 z-10 mt-3 w-full float-right max-w-full -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-full"
            >
