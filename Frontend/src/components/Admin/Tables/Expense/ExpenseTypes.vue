    ...
    <section class="w-full dark:bg-gray-900 py-3 sm:py-5">
        <div class="px-4 mx-auto w-full ">
            <div class="w-full relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                <div class=" flex flex-col  bg-gray-400/50  lg:flex-row lg:items-center lg:justify-between py-4 px-6">
                    <TableCard heading=" Total Expense Types" :amount="450" class="text-gray-950 bg-white/50">
                      <CalculatorIcon class="w-12 h-12 border border-pink-200 rounded-md p-2"/>
                    </TableCard>
                    <TableCard heading=" Total Expense Types" :amount="450" class="text-gray-950 bg-white/50">
                      <CalculatorIcon class="w-12 h-12 border border-pink-200 rounded-md p-2"/>
                    </TableCard>
