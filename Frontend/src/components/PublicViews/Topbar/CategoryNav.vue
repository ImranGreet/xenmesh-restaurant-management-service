<template>
  <div class="bg-white w-full">
      <div class="w-full flex justify-between items-center gap-x-4 py-3">
            <router-link to="#" v-for="cat in categories" :key="cat.id">
               <itemCategory :productPhoto="cat.image" :title="cat.category"/>
            </router-link>
      </div>
  </div>
</template>
